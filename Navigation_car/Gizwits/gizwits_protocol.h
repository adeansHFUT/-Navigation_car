...
* @{
*/
#define PRODUCT_KEY "e24b6379485641ad817c1b7242a2e95b"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "a1ee150c37c94ac9aa6ebb8008f92fec"
...
* @{
*/
#define START_BYTEOFFSET                    0
#define START_BITOFFSET                     0
#define START_LEN                           5
#define END_BYTEOFFSET                    0
#define END_BITOFFSET                     5
#define END_LEN                           5
#define Obstacle_BYTEOFFSET                    3
#define Obstacle_BITOFFSET                     0
#define Obstacle_LEN                           1

#define CurrentPoint_RATIO                         1
#define CurrentPoint_ADDITION                      1
#define CurrentPoint_MIN                           0
#define CurrentPoint_MAX                           19
/**@} */
